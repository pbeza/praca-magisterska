...
\item Zaimplementowane \textbf{rozwiązanie było testowane na}~dystrybucjach \texttt{Debian} i~\texttt{ArchLinux}, ale~jest \textbf{napisane w~Python} i~prawdopodobnie działa również na~innych.
}
