...
{
	name={demon},
	description={\hrefemph{https://en.wikipedia.org/wiki/Daemon_(computing)}{Daemon}. Program komputerowy działający w~tle. Nazwy \glslink{demon}{demonów} w~systemach \glslink{unix-like-system}{*niksowych} zwyczajowo kończą się literą~\href{https://unix.stackexchange.com/questions/72587/why-do-some-linux-files-have-a-d-suffix}{\textbf{d}}.}
}
\newglossaryentry{rfc}
{
	name={RFC},
