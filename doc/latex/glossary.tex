...
{
	name={demon},
	description={Program komputerowy działający w~tle. Nazwy \glslink{demon}{demonów} w~systemach \glslink{unix-like-system}{*niksowych} zwyczajowo kończą się literą~\textbf{d}}
}
\newglossaryentry{rfc}
{
	name={RFC},
