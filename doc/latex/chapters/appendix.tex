...
user@host:/tmp/demo$ rm file8_hardlink
user@host:/tmp/demo$ rm dir1/subdir1/file4
...
\newpage
\begin{lstlisting}[language=,numbers=none,caption={Drugie skanowanie drzewa katalogów \protect\path{/tmp/demo} --- po~zmianach przedstawionych na~listingu~\ref{lst:tree-change-aide-example} i~zwizualizowanych na~rys.~\ref{fig:drzewo-katalogow-przyklad-aide}},label=lst:aide-example-second-scan]
...
\begin{figure}
	...
	\end{subfigure}
	\caption{Drzewo katalogów \protect\path{/tmp/demo} utworzone w~sposób przedstawiony na~listingu~\ref{lst:tree-create-aide-example} przed i~po~dokonaniu zmian przedstawionych na~listingu~\ref{lst:tree-change-aide-example}}
