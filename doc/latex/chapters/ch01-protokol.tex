...
Problem braku standaryzacji protokołów niezawodnego multicastingu został dostrzeżony przez organizację~\gls{ietf}, która powołała zespół \hrefemph{https://irtf.org/concluded/rmrg}{IRTF~Reliable Multicast Research Group} oraz \hrefemph{https://ietf.org/wg/concluded/rmt}{Reliable Multicast Transport Working Group} mający na~celu rozwiązywać problemy w~proponowanych protokołach niezawodnego multicastingu.
