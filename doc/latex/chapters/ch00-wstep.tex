...
\end{enumerate}
Aplikacja również składa~się z~dwóch części, co~jest naturalne dla~przyjętej architektury klient-serwer~(por.~rozdział~\ref{sec:cel-i-zakres}):
\begin{enumerate}
