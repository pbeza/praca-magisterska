...
WARNING [2017-08-21 16:51:01,159] This application is supposed to be ran with root permissions. Root permissions may be not needed if you don't need to apply myscm system image that modifies restricted files.
...
WARNING [2017-08-21 16:55:18,949] This application is supposed to be ran with root permissions. Root permissions may be not needed if you don't need to apply myscm system image that modifies restricted files.
